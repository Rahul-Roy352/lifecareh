...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Life Care H — Empowering Rural Odisha Since 2002" },
      { name: "description", content: "Life Care H is a grassroots voluntary organization in Odisha working on community empowerment, livelihoods, health, education and the environment." },
      { property: "og:title", content: "Life Care H — Empowering Rural Odisha" },
      { property: "og:description", content: "Grassroots social work across Puri, Cuttack and Angul districts since 2002." },
    ],
    links: [
  ...
  return (
    <main>
      <section className="relative min-h-screen w-full overflow-hidden">
        ...
        <div className="relative z-10 flex min-h-screen flex-col items-center justify-center px-6 text-center text-white">
          ...
          <div className="mt-12 flex flex-wrap gap-4 justify-center">
            ...
            <Link to="/contact" className="btn-donate" style={{ backgroundColor: "transparent", border: "1px solid white" }}>Get In Touch</Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 md:py-32 bg-background">
        <div className="mx-auto max-w-6xl px-8">
          <p className="eyebrow text-primary mb-4">Voices From The Field</p>
          <h2 className="font-display text-3xl md:text-5xl leading-[1.15] text-foreground max-w-3xl">
            Stories of dignity, livelihoods and quiet courage
          </h2>
      ...
      <section className="relative min-h-[70vh] w-full overflow-hidden">
        ...
        <div className="absolute inset-0 bg-black/55" />
        <div className="relative z-10 mx-auto flex min-h-[70vh] max-w-5xl flex-col items-center justify-center px-8 text-center text-white">
