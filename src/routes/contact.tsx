...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Contact — Life Care H" },
      { name: "description", content: "Get in touch with Life Care H. Headquarters in Kalama Chhuin, Angul, Odisha. Email lifecaretalcher@gmail.com." },
      { property: "og:title", content: "Contact Life Care H" },
      { property: "og:description", content: "Reach our team in Angul, Odisha." },
    ],
  }),
  component: Contact,
});
    ...
    <main className="bg-background">
      ...
      <section className="py-20 md:py-28">
        <div className="mx-auto max-w-3xl px-8">
          ...
          <form className="mt-10 space-y-6" onSubmit={(e) => { e.preventDefault(); alert("Thank you — we'll be in touch shortly."); }}>
